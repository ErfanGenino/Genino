  ...
  return (
    <GeninoDNABackground strands={10} opacity={0.25} duration={90}>
      <main dir="rtl" className="relative z-10 flex flex-col items-center px-6 py-16 text-gray-800">
        ...
        >
          این آزمون برای بررسی سلامت دهان، لثه و دندان‌های کودک طراحی شده است.  
          لطفاً بررسی ظاهری دهان کودک، نحوه مسواک‌زدن و نشانه‌های التهاب را طبق مراحل بعدی انجام دهید.
        </motion.p>
