  ...
  return (
    <GeninoDNABackground strands={10} opacity={0.25} duration={90}>
      ...
      >
        ...
        >
          این بخش برای بررسی احساسات، واکنش‌های عاطفی و ثبات هیجانی کودک طراحی شده است.  
          هدف، درک بهتر از وضعیت روانی کودک و آگاهی والدین از نیازهای احساسی اوست.
        </motion.p>
