  ...
  return (
    <GeninoDNABackground strands={10} opacity={0.25} duration={90}>
      ...
      >
        ...
        >
          این بخش برای بررسی مهارت‌های حرکتی درشت و ظریف کودک طراحی شده است.  
          تعادل، راه رفتن، گرفتن اشیا و هماهنگی حرکات از شاخص‌های کلیدی رشد حرکتی محسوب می‌شوند.
        </motion.p>
