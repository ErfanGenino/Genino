// 📄 src/pages/ChildHealthCheck/SocialCheck.jsx
  ...
  return (
    <GeninoDNABackground strands={10} opacity={0.25} duration={90}>
      ...
      >
        ...
        >
          این بخش برای بررسی نحوه ارتباط کودک با دیگران طراحی شده است.  
          توانایی در برقراری ارتباط، همکاری، درک احساسات دیگران و تعامل گروهی  
          از شاخص‌های مهم رشد اجتماعی کودک محسوب می‌شوند.
        </motion.p>
